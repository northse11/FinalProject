...
namespace FinalProject.Migrations
{
    ...
    [Migration("20241121182905_innitialwithData")]
    partial class innitialwithData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalProject.Models.Hobby", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HobbyID = 1,
                            HobbyActive = false,
                            HobbyAge = new DateTime(2024, 1, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            HobbyDescription = "Checkers..",
            ...
            modelBuilder.Entity("FinalProject.Models.TeamMember", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Birthdate = new DateTime(2024, 1, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Jon",
                            LastName = "Sanjuan",
                            Program = "Software",
                            Year = "Junio"
